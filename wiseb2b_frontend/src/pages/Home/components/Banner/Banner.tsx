...
export const Banner = () => {
  ...
  return (
    <div className={classnames(
      ...
      'StylePath-Pages-Home-components-Banner'
    )}>
      <Grid container>
        ...
        <Grid item xs={12} md={4} lg={3}>
          <div className={styles.sidebar}>
            <div className={styles.newsBlock}>
              <Link to="/wip" className={styles.title}>{homeHomeArticlesGroupData?.title}</Link>
            ...
            {promotionCountdown && (
              <div className={styles.counterWrapper}>
                ...
                <div className={styles.counter}>
                  ...
                  <span>:</span>
                  <span className={styles.number}>{Math.floor(promotionCountdown.minutes / 10)}</span>
                  <span className={styles.number}>{promotionCountdown.minutes % 10}</span>
                  <span>:</span>
                  <span className={styles.number}>{Math.floor(promotionCountdown.seconds / 10)}</span>
