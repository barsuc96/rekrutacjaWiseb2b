...
const getOrderPositions = (orderId: number, params?: IRequest): Promise<IResponse> =>
  axios.get(`/orders/${orderId}/positions`, { params });

export const useGetOrderPositions = (
  orderId: number,
  params?: IRequest,
  ...
  useQuery<IResponse, IError>(
    ...
    () => getOrderPositions(orderId, params),
    options
  );
